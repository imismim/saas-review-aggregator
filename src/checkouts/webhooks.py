...
def handle_subscription_created(sub_data):
    ...
    logger.info(f"Handling subscription.created for stripe_id={stripe_id}, customer_id={customer_id}, selected_restaurant_ids={selected_restaurant_ids}")
